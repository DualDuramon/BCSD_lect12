...
public class DayAndNight : MonoBehaviour
{
    ...
    [SerializeField]private float dayFogDensity;                        //낮 안개 밀도
    [SerializeField] private float currentFogDensity;                    //현재 안개 밀도
    ...
    void Update()
    {
        ...
        else if (transform.eulerAngles.x >= 170) //태양의 rotation의 x값이 170 이상
        {
